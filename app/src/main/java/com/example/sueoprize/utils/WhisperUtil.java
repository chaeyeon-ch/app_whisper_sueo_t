package com.example.sueoprize.utils;
...
public class WhisperUtil {
    ...
    public boolean loadFiltersAndVocab(boolean multilingual, String vocabPath) throws IOException {
        ...
        fis.close();
        byte[] bytes = baos.toByteArray(); // ← Files.readAllBytes 대체
    ...
    public int getTokenLang(String langCode) {
        switch (langCode.toLowerCase()) {
            case "en": return 50259;
            case "es": return 50262;
            case "hi": return 50276;
            case "te": return 50299;
            case "ko": return 50263; // 한국어 추가
            case "ja": return 50264; // 일본어 예시
            case "zh": return 50265; // 중국어 예시
            default:
